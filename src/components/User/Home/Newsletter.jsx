        ...
        <div className='flex flex-col justify-center items-center gap-2 md:gap-5 p-5'>
            <div className='w-full md:w-[650px] text-center'>
                ...
                <form className="flex flex-col md:flex-row items-center justify-center mt-5">
                    <div className='bg-gray-100 border border-gray-300 rounded-lg py-2 px-3'>
                    ...
                    <button type='submit' className='p-2 h-full ml-0 mt-2 md:mt-0 md:ml-2 p-500 text-lg bg-gray-950 rounded-lg text-white px-6 w-full md:w-fit'>Subscribe</button>
                </form>
            </div>
        </div>
